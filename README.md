...
<h3>Также, чтобы убедиться, что пакеты дошли до компьютеров, можно обратиться к программному обеспечению Wireshark и проверить с помощью него. В Wireshark можно захватить порты компьютеров eth0 и посмотреть содержание пакетов. Был направлен пинг с компьютера PC1 с адресом 192.168.1.1 на внешний адрес 200.0.0.10, который соответствует также локальному адресу 192.168.1.1 или PC4.  На рисунке ниже изображено окно Wireshark порта eth0 компьютера PC4.
</h3>

<h4>Wireshark PC4</h4>

![image](https://github.com/user-attachments/assets/5dd02242-8880-46ad-8a95-3ba3a73643c6)

<h3>Был направлен пинг с компьютера PC3 с адресом 192.168.4.1 на внешний адрес 50.0.0.20, который соответствует локальному адресу 192.168.4.1 или PC2.  На рисунке ниже изображено окно Wireshark порта eth0 компьютера PC2.</h3>
<h4>Wireshark PC2</h4>

![image](https://github.com/user-attachments/assets/305fc7ca-1d5f-464d-b30b-efa4cbc22864)

<h2>Вывод:</h2>
<h3>В данной работе настроены 2 идентичных сети со статической маршрутизацией. Также был настроен статический NAT, чтобы у компьютеров из 1 сети была связь с компьютерами из другой. После настройки 2-х сетей и всех устройств в них, была выполнена проверка работы сети, что включало в себя проверку статической маршрутизации между устройствами, а также проверку работы NAT между двух сетей. Проверка осуществлялась путем отправки PING между устройствами одной сети, и с использованием инструмента для просмотра пакетов Wireshark.</h3>
